const swordvoices = [
  {
    ...
    portfolio: "https://www.swordvoice.com/",
  },
  {
    ...
    portfolio: "https://ilemarandrade.vercel.app/",
  },
  {
    photo: "/swordvoices/juan.jpeg",
    name: "Juan Contreras",
    description:
      "Profesional de IT con mas de 20 años de experiencia en Gestion de Equipos y/o Proyectos; 4 años en Desarrollo Movil y Web. Interés en el desarrollo de las capacidades de otros (Mentorias).",
  ...
  },
  {
    ...
    description: `Mentora, eficiente en el desarrollo de interfaces de usuarios, minusiosa y creativa en el diseño "pixel to pixel" y responsivo de apps.`,
